...
p11 = sin(1:20)*8;   % If input is wave with amplitude of 3
t11 = ones(1,20)*8;  % then output should be 3

p12 = sin(1:20)*5;   % If input is wave with amplitude of 3
t12 = ones(1,20)*5;  % then output should be 3

%    The network will be trained on the sequence formed by
%    repeating each wave form twice.

p = [p1 p2 p11 p12 p1 p2 p11 p12];
t = [t1 t2 t11 t12 t1 t2 t11 t12];
...
%net = newelm(p,t,[80],{'tansig','purelin'},'traingdx');
