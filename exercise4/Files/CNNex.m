...
outputFolder = 'C:\Users\cris\Documents\KULeuven\SECONDSEM\ANN\exercises\ex4\CNN\caltech101\';
...
cnnMatFile = 'C:\Users\cris\Documents\KULeuven\SECONDSEM\ANN\exercises\ex4\CNN\imagenet-caffe-alex.mat'%fullfile(tempdir, 'imagenet-caffe-alex.mat');
...
tama2 = size(convnet.Layers(2).Weights)
tama6 = size(convnet.Layers(6).Weights)
tama10 = size(convnet.Layers(10).Weights)
