...
%                net.divideParam.testRatio = 0;
        ...
        save(strcat('TEST3/relu/3layer/std_matrix_results_',int2str(numNeurons),'_',int2str(attempt),'.mat'),'results_matrix');
        save(strcat('TEST3/relu/3layer/std_training_results_',int2str(numNeurons),'_',int2str(attempt),'.mat'),'training_results');
    end
end
